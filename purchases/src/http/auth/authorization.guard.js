...
var AuthorizationGuard = /** @class */ (function () {
    function AuthorizationGuard(configService) {
        ...
        this.AUTH0_AUDIENCE = (_a = configService.get('AUTH0_AUDIENCE')) !== null && _a !== void 0 ? _a : '';
        this.AUTH0_DOMAIN = (_b = configService.get('AUTH0_DOMAIN')) !== null && _b !== void 0 ? _b : '';
    }
    AuthorizationGuard.prototype.canActivate = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var httpContext, request, response, checkJWT, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, checkJWT(request, response)];
                    case 2:
                        _a.sent();
